...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 04 juin 2026 à 14:27
...
(14, 1, 'aa', 'a', 'a', 'aa', 'aa@gmai.com'),
(15, 1, 'aa', 'a', 'a', 'aa', 'aa@gmai.com');
...
(0, 14, '2026-06-04', 1705),
(0, 15, '2026-06-04', 1629);
...
INSERT INTO `contenir` (`id_comm`, `id_article`, `qte`, `prix_unit`) VALUES
(0, 'CS330', 1, 1629);
...
CREATE TABLE `utilisateur` (
  ...
  `datei` datetime NOT NULL DEFAULT current_timestamp()
...
INSERT INTO `utilisateur` (`id_user`, `username`, `secretPass`, `datei`) VALUES
